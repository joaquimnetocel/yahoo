<script lang="ts">
	import GraficoDeLinhas from '$lib/apexcharts/componentes/GraficoDeLinhas.svelte';
			...
			<div class="min-h-l00">
				...
				{:else if deriveds.promessaDeDadosDoYahooFinance.error}
					<p class="text-destructive">
						Erro: {deriveds.promessaDeDadosDoYahooFinance.error.message}
					</p>
				{:else}
					<h2 class="text-lg font-bold mb-2">
						<div class="flex justify-between">
							...
							<div>DIAS INVESTIDO: {deriveds.dias}</div>
							<div
								class:text-green-500={deriveds.lucro > 0}
								class:text-red-500={deriveds.lucro < 0}
							>
